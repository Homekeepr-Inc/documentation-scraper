...
class LGSpider(scrapy.Spider):
    ...
    def start_requests(self) -> Iterable[scrapy.Request]:
        base = "https://www.lg.com/us/support"
            ...
            yield scrapy.Request(
                ...
                meta={
                    ...
                    "playwright_page_methods": [
                        ...
                        PageMethod("fill", "input[name=search]", model),
                        PageMethod("press", "input[name=search]", "Enter"),
    ...
    def parse_search(self, response: scrapy.http.Response, model: str):
        ...
        title = response.css("title::text").get() or f"LG {model} manual"
        for href in links:
